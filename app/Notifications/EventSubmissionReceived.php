...
class EventSubmissionReceived extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("Thanks for submitting “{$this->event->name}”.")
            ->line('Our team will review it shortly. You’ll get an email once it’s approved or if we need changes.')
            ->action('View Your Submissions', route('contributor.events.index'))
