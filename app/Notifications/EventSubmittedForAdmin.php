...
class EventSubmittedForAdmin extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        $mail = (new MailMessage)
            ->subject('New Event Submission — Approval Needed')
            ->greeting('Hi Admin,')
            ->line("“{$this->event->name}” was submitted by {$this->submitter->name}.")
