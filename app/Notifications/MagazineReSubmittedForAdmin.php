...
class MagazineReSubmittedForAdmin extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $mail = (new MailMessage)
            ->subject('Magazine ' . ucfirst($statusText) . ' — Approval Needed')
            ->greeting('Hi Admin,')
            ->line("“{$this->magazine->title}” was {$statusText} by {$this->submitter->name}.")
