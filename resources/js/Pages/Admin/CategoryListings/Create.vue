<template>
    <AdminLayout>
        ...
        <Head title="Add Content Listing" />

        <div class="w-full mx-auto p-6 bg-white rounded-xl shadow-xl">
            <div class="mb-6 border-b pb-4">
                <h2 class="text-2xl font-semibold text-blueGray-800">Add New Content Listing</h2>
            </div>
            <div class="mb-6">
...
async function submit() {
    ...
    form.post(route('admin.category-listings.store'), {
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => toast.success('Category Listing created successfully'),
