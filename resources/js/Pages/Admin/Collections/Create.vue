<template>
    <AdminLayout>
        ...
        <Head title="Add Collection / Venture" />

        <div class="w-full mx-auto p-6 bg-white rounded-xl shadow-xl">
            <div class="mb-6 border-b pb-4">
                <h2 class="text-2xl font-semibold text-blueGray-800">Add New Collection / Venture</h2>
            </div>
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-6">
                    ...
                    <!-- Embedded Content -->
                    <div>
                        <label class="block text-sm font-bold text-blueGray-700 mb-1">Select Content Listings</label>
