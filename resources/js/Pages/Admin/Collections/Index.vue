    ...
    <AdminLayout>
        ...
        <div class="p-4">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-2xl font-semibold text-blueGray-800">Collections</h2>
                <!-- Buttons on the right -->
                <div class="flex gap-2">
                    <Link :href="route('admin.collections.settings')"
...
function doSearch(query) {
    ...
    router.get(route('admin.collections.index'), { search: query }, {
        preserveScroll: true,
        preserveState: true,
        replace: true
    })
...
function goToPage(page) {
    ...
    router.visit(route('admin.collections.index', { page }))
}
</script>