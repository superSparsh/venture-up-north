<template>
    <AdminLayout>
        ...
        <Head :title="`Edit Event Page Settings`" />

        <div class="w-full mx-auto bg-white rounded-xl shadow-xl p-8">
            <div class="mb-6 border-b pb-4">
                <h2 class="text-2xl font-semibold text-blueGray-800">Edit Event Page Settings</h2>
            </div>
...
function submit() {
    ...
    form.post(route('admin.events.settings.update', props.setting.id), {
        preserveScroll: true,
        forceFormData: true,
