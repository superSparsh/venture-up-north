...
function save() {
    form.put(route('admin.terms.update'), {
            ...
            <div class="bg-white p-6 rounded-xl shadow space-y-4" :key="JSON.stringify(terms)">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-6 text-end">
                        <button @click="save" class="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-6 py-2 rounded-md shadowbg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-6 py-2 rounded-md shadow">Save</button>
                    </div>
                </div>
            </div>
        </div>
