<template>
    <AdminLayout>
        ...
        <Head :title="`Edit Tour Page Settings`" />

        <div class="w-full mx-auto bg-white rounded-xl shadow-xl p-8">
            <div class="mb-6 border-b pb-4">
                <h2 class="text-2xl font-semibold text-blueGray-800">Edit Tour Page Settings</h2>
            </div>
...
function submit() {
    ...
    form.post(route('admin.tour.settings.update', props.setting.id), {
        preserveScroll: true,
        forceFormData: true,
