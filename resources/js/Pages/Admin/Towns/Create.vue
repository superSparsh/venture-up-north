    ...
    <AdminLayout>
        ...
        <div class="w-full mx-auto p-6 bg-white rounded-xl shadow-xl">
            <div class="mb-6 border-b pb-4">
                <h2 class="text-2xl font-semibold text-blueGray-800">Add New Town</h2>
            </div>
...
async function submit() {
    ...
    form.post(route('admin.towns.store'), {
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => toast.success('Town created successfully'),
        onError: () => toast.error('Failed to create town'),
    })
}
</script>