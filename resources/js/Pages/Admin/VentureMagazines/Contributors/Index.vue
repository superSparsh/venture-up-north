<template>
    ...
    <AdminLayout>
        ...
        <Head title="Contributor's Venture Magazines" />

        <div class="p-4">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-2xl font-semibold text-blueGray-800">Contributor's Venture Magazines</h2>
            ...
            <DataTable :items="magazines.data" :columns="columns" :meta="magazines" :pagination="true"
                ...
                <template #item-contributor="{ item }">
                    {{ item.real_contributor?.author.display_name || '—' }}
                </template>

                <!-- Status chip (based on workflow) -->
                ...
                <template #actions="{ item }">
                    ...
                    <template v-if="item.status === 'pending'">
                        <Link :href="route('admin.magazines.review', item.slug)"
...
const columns = [
    ...
    { key: 'status', label: 'Status' },       // ← switched from is_published to status
