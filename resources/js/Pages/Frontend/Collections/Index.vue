...
import FilterableCollection from '@/Components/Frontend/FilterableCollection.vue'
...
<template>
    <Layout>
        ...
        <SeoMeta :title="`Explore ${collection.name} - Venture Up North`" :description="collection.summary"
            :image="collection.seo_image" :canonical="`https://venturedownsouth.com/explore/${collection.slug}`"
        ...
        <FilterableCollection :api-route="`/api/collections`" :tags="tags"
            :collection="collection" :initialItems="initialItems" />
    </Layout>
</template>
