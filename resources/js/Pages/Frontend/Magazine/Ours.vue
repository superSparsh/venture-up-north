...
function submit(e) {
    ...
    router.get(route('ours.magazine'), filters, {
        preserveScroll: true,
        preserveState: true,
        replace: true
    })
...
<template>
    <Layout>
        ...
        <Head title="Our Venture Magazine - Venture Up North" />

        <!-- HERO -->
        <section class="relative w-full h-screen overflow-hidden text-white">
            <img src="/public/images/Venture-Up-North.png" alt="Our Ventures"
                class="absolute inset-0 w-full h-full object-cover z-0" />
            <div class="absolute inset-0 bg-black/40 z-10"></div>
            <div class="relative z-20 h-full flex items-center" data-aos="fade-up">
                <div class="container mx-auto px-4">
                    <h1 class="text-white text-4xl md:text-6xl font-extrabold tracking-widest uppercase">Our Venture
                        Magazine
                    </h1>
                    <p class="mt-3 max-w-2xl text-white/80">Browse magazines created by us.</p>
                </div>
            </div>
        </section>

        <section class="container mx-auto px-4 py-8 text-heavy space-y-6 mb-5">
            <MagazineTabs active="our" :magazinePopup="magazinePopup" />
            <!-- Filters -->
